...
function KIcon({ name, size = 18, stroke = 1.6, ...rest }) {
  ...
  switch (name) {
    ...
    case 'user-plus':
      return (
        <svg viewBox="0 0 24 24" {...s} {...rest}>
          ...
          <path d="M3 20c0-3.2 2.8-5 6-5s6 1.8 6 5" {...common} />
          <path d="M18.5 7v6M15.5 10h6" {...common} />
        </svg>
      );
    case 'share':
      return (
        <svg viewBox="0 0 24 24" {...s} {...rest}>
          ...
          <circle cx="17.5" cy="5.5" r="2.6" {...common} />
          <circle cx="17.5" cy="18.5" r="2.6" {...common} />
          <path d="M8.4 10.7l6.7-3.9M8.4 13.3l6.7 3.9" {...common} />
        </svg>
      );
    case 'copy':
      return (
        <svg viewBox="0 0 24 24" {...s} {...rest}>
          <rect x="9" y="9" width="11" height="11" rx="2.5" {...common} />
          <path d="M15 5H7a3 3 0 0 0-3 3v8" {...common} />
        </svg>
      );
    case 'heart':
      return (
        <svg viewBox="0 0 24 24" {...s} {...rest}>
          <path d="M12 20.5C7 16.5 3.5 13.4 3.5 9.6A4.4 4.4 0 0 1 12 7.8a4.4 4.4 0 0 1 8.5 1.8c0 3.8-3.5 6.9-8.5 10.9z" {...common} />
        </svg>
      );
    ...
    case 'droplet':
      return (
        <svg viewBox="0 0 24 24" {...s} {...rest}>
          <path d="M12 3.2c3.4 3.7 5.4 6.4 5.4 8.9a5.4 5.4 0 0 1-10.8 0c0-2.5 2-5.2 5.4-8.9z" {...common} />
        </svg>
      );
    case 'google':
      return (
    ...
    case 'trending-down':
      return (
        <svg viewBox="0 0 24 24" {...s} {...rest}>
          <path d="M4 8l5 5 4-4 7 7" {...common}/>
          <path d="M16 16h4v-4" {...common}/>
        </svg>
      );
    case 'info':
      return (
    ...
    case 'pin-off':
      return (
        <svg viewBox="0 0 24 24" {...s} {...rest}>
          <path d="M9.5 3.5h5l-.8 5.2 2.8 3.6H7.5l2.8-3.6z" {...common}/>
          <path d="M12 12.3V20.5" {...common}/>
          {name === 'pin-off' && <path d="M4.5 4.5l15 15" {...common}/>}
        </svg>
      );
    case 'pin': // location
      return (
