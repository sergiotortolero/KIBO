...
const CELESTIAL = [
{ n: 1, name: 'Cadete Estelar', sub: 'Primer ascenso', type: 'cadete', a: 'var(--kb-rank-cadete-a)', b: 'var(--kb-rank-cadete-b)', ink: 'var(--kb-rank-cadete-ink)', glow: 'var(--kb-rank-cadete-glow)' },
{ n: 2, name: 'Piloto Orbital', sub: 'Vuelo libre', type: 'piloto', a: 'var(--kb-rank-cadete-a)', b: 'var(--kb-rank-cadete-b)', ink: 'var(--kb-rank-cadete-ink)', glow: 'var(--kb-rank-cadete-glow)' },
{ n: 3, name: 'Explorador Sideral', sub: 'Vanguardia', type: 'explorador', a: 'var(--kb-rank-cadete-a)', b: 'var(--kb-rank-cadete-b)', ink: 'var(--kb-rank-cadete-ink)', glow: 'var(--kb-rank-cadete-glow)' },
{ n: 4, name: 'Teniente Sideral', sub: 'Oficial', type: 'teniente', a: 'var(--kb-rank-teniente-a)', b: 'var(--kb-rank-teniente-b)', ink: 'var(--kb-rank-teniente-ink)', glow: 'var(--kb-rank-teniente-glow)' },
{ n: 5, name: 'Capitán de Nave', sub: 'Al mando', type: 'capitan', a: 'var(--kb-rank-teniente-a)', b: 'var(--kb-rank-teniente-b)', ink: 'var(--kb-rank-teniente-ink)', glow: 'var(--kb-rank-teniente-glow)' },
{ n: 6, name: 'Comandante de Flota', sub: 'Flota propia', type: 'flota', a: 'var(--kb-rank-teniente-a)', b: 'var(--kb-rank-teniente-b)', ink: 'var(--kb-rank-teniente-ink)', glow: 'var(--kb-rank-teniente-glow)' },
{ n: 7, name: 'Comodoro Galáctico', sub: 'Líder de escuadra', type: 'comodoro', a: 'var(--kb-rank-granalmirante-a)', b: 'var(--kb-rank-granalmirante-b)', ink: 'var(--kb-coin-ink)', glow: 'var(--kb-rank-granalmirante-glow)' },
{ n: 8, name: 'Almirante', sub: 'Alto mando', type: 'almirante', a: 'var(--kb-rank-granalmirante-a)', b: 'var(--kb-rank-granalmirante-b)', ink: 'var(--kb-coin-ink)', glow: 'var(--kb-rank-granalmirante-glow)' },
{ n: 9, name: 'Almirante de Galaxias', sub: 'Dominio galáctico', type: 'galaxias', a: 'var(--kb-rank-granalmirante-a)', b: 'var(--kb-rank-granalmirante-b)', ink: 'var(--kb-coin-ink)', glow: 'var(--kb-rank-granalmirante-glow)' },
{ n: 10, name: 'Gran Almirante', sub: 'Mando supremo', type: 'granalmirante', a: 'var(--kb-rank-granalmirante-a)', b: 'var(--kb-rank-granalmirante-b)', ink: 'var(--kb-rank-granalmirante-ink)', glow: 'var(--kb-rank-granalmirante-glow)', fancy: true },
{ n: 11, name: 'Señor de Constelaciones', sub: 'Soberano estelar', type: 'constelacion', a: 'var(--kb-rank-arquitecto-a)', b: 'var(--kb-rank-arquitecto-b)', ink: 'var(--kb-rank-arquitecto-ink)', glow: 'var(--kb-rank-arquitecto-glow)', fancy: true },
{ n: 12, name: 'Soberano del Cosmos', sub: 'Trono cósmico', type: 'soberano', a: 'var(--kb-rank-arquitecto-a)', b: 'var(--kb-rank-arquitecto-b)', ink: 'var(--kb-rank-arquitecto-ink)', glow: 'var(--kb-rank-arquitecto-glow)', fancy: true },
{ n: 13, name: 'Arquitecto de Estrellas', sub: 'Forja de soles', type: 'arquitecto', a: 'var(--kb-rank-arquitecto-a)', b: 'var(--kb-rank-arquitecto-b)', ink: 'var(--kb-rank-arquitecto-ink)', glow: 'var(--kb-rank-arquitecto-glow)', fancy: true },
{ n: 14, name: 'Titán Cósmico', sub: 'Fuerza universal', type: 'titan', a: 'var(--kb-rank-titan-a)', b: 'var(--kb-rank-titan-b)', ink: 'var(--kb-rank-titan-ink)', glow: 'var(--kb-rank-titan-glow)', fancy: true },
{ n: 15, name: 'Avatar Cósmico', sub: 'Forma trascendente', type: 'avatar', a: 'var(--kb-rank-avatar-a)', b: 'var(--kb-rank-avatar-b)', ink: 'var(--kb-rank-avatar-ink)', glow: 'var(--kb-rank-avatar-glow)', fancy: true },
{ n: 16, name: 'Leyenda', sub: 'Singularidad', type: 'blackhole', a: 'var(--kb-rank-blackhole-a)', b: 'var(--kb-rank-blackhole-b)', ink: 'var(--kb-rank-blackhole-ink)', glow: 'var(--kb-rank-blackhole-glow)', master: true }];
...
function rankGroup(i) {
  ...
  if (i <= 2) return { t: 'chevron', c: i + 1, a: 'var(--kb-mat-bronce-a)', b: 'var(--kb-mat-bronce-b)', ink: 'var(--kb-mat-bronce-ink)', name: 'Bronce' };
  if (i <= 5) return { t: 'bar', c: i - 2, a: 'var(--kb-mat-plata-a)', b: 'var(--kb-mat-plata-b)', ink: 'var(--kb-mat-plata-ink)', name: 'Plata' };
  if (i <= 8) return { t: 'star', c: i - 5, a: 'var(--kb-mat-oro-a)', b: 'var(--kb-mat-oro-b)', ink: 'var(--kb-coin-ink)', name: 'Oro' };
  if (i <= 11) return { t: 'eagle', c: i - 8, a: 'var(--kb-mat-platino-a)', b: 'var(--kb-mat-platino-b)', ink: 'var(--kb-mat-platino-ink)', name: 'Platino' };
  if (i <= 13) return { t: 'wreath', c: i - 11, a: 'var(--kb-mat-obsidiana-a)', b: 'var(--kb-mat-obsidiana-b)', ink: 'var(--kb-mat-obsidiana-ink)', name: 'Obsidiana' };
  if (i <= 15) return { t: 'diamond', c: i - 13, a: 'var(--kb-mat-diamante-a)', b: 'var(--kb-mat-diamante-b)', ink: 'var(--kb-mat-diamante-ink)', name: 'Diamante', anim: 'shine' };
  if (i <= 17) return { t: 'diamond', c: i - 15, a: 'var(--kb-mat-esmeralda-a)', b: 'var(--kb-mat-esmeralda-b)', ink: 'var(--kb-mat-esmeralda-ink)', name: 'Esmeralda', anim: 'shine' };
  if (i === 18) return { t: 'crown', c: 1, a: 'var(--kb-mat-rubi-a)', b: 'var(--kb-mat-rubi-b)', ink: 'var(--kb-mat-rubi-ink)', name: 'Rubí', anim: 'shine' };
  return { t: 'crown', c: 1, a: 'var(--kb-mat-damasco-a)', b: 'var(--kb-mat-damasco-b)', ink: 'var(--kb-mat-damasco-ink)', name: 'Damasco', anim: 'oil' };
}
    ...
    switch (t.type) {
      ...
      case 'blackhole': // Leyenda — singularidad dentro del medallón (mismo estándar), animada
        return <g>
          ...
          <path d="M30 50 A20 20 0 0 1 70 50" fill="none" stroke="var(--kb-parch-glow)" strokeWidth="1.4" opacity="0.9" strokeLinecap="round" />
          ...
          <ellipse className="bh-orbit" cx="50" cy="50" rx="30" ry="7" fill="none" stroke="var(--kb-parch-glow)" strokeWidth="2.6" pathLength="100" strokeDasharray="16 84" strokeLinecap="round" opacity="0.95" />
    ...
    <svg viewBox="0 0 100 100" width={size} height={size} className={`kbv-emblem cel ${master ? 'master' : ''} ${fancy ? 'fancy' : ''} ${locked ? 'locked' : ''}`} aria-hidden="true">
      <defs>
        <radialGradient id={rg} cx="42%" cy="38%" r="70%">
          <stop offset="0" stopColor={locked ? 'var(--kb-parch-5)' : glow} />
          <stop offset="0.55" stopColor={A} />
          <stop offset="1" stopColor={B} />
        </radialGradient>
        <radialGradient id={coreG} cx="50%" cy="42%" r="62%">
          <stop offset="0" stopColor={locked ? 'var(--kb-parch-6)' : 'var(--kb-void-1)'} />
          <stop offset="1" stopColor={locked ? 'var(--kb-parch-7)' : 'var(--kb-void-2)'} />
        </radialGradient>
        {ringLvl >= 10 &&
        <linearGradient id={prismId} x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="var(--kb-spark-red)" /><stop offset="0.18" stopColor="var(--kb-spark-amber)" />
          <stop offset="0.36" stopColor="var(--kb-spark-yellow)" /><stop offset="0.54" stopColor="var(--kb-spark-green)" />
          <stop offset="0.72" stopColor="var(--kb-rank-accent-1)" /><stop offset="0.86" stopColor="var(--kb-rank-accent-2)" />
          <stop offset="1" stopColor="var(--kb-rank-accent-3)" />
        </linearGradient>}
      </defs>
      ...
      {ringFx()}
      {locked &&
      <g opacity="0.82"><rect x="42" y="49" width="16" height="13" rx="2.5" fill="var(--kb-rank-accent-4)" /><path d="M44 49 V44 a6 6 0 0 1 12 0 V49" fill="none" stroke="var(--kb-rank-accent-4)" strokeWidth="2.6" /></g>
      }
    </svg>);
...
function RankEmblem({ level = 1, size = 50, locked = false }) {
  ...
  const A = locked ? 'var(--kb-parch-1)' : g.a,B = locked ? 'var(--kb-parch-3)' : g.b,ink = locked ? 'var(--kb-parch-4)' : g.ink;
  ...
  function insignia() {
    ...
    } else if (g.t === 'diamond') {// piedras facetadas (Diamante / Esmeralda)
    ...
    <svg viewBox="0 0 100 100" width={size} height={size} className={`kbv-emblem rank ${locked ? 'locked' : ''} ${anim ? 'anim-' + anim : ''}`} aria-hidden="true">
      <defs>
        ...
        <linearGradient id={uid} x1="0" y1="0" x2="1" y2="1">
            <stop offset="0" stopColor="var(--kb-rank-accent-5)" />
            <stop offset="0.28" stopColor="var(--kb-rank-accent-6)" />
            <stop offset="0.52" stopColor="var(--kb-rank-accent-7)" />
            <stop offset="0.76" stopColor="var(--kb-rank-accent-8)" />
            <stop offset="1" stopColor="var(--kb-rank-accent-9)" />
          </linearGradient> :
      ...
      <g clipPath={`url(#${uid}c)`}>
        ...
        <path key={k} d={`M8 ${y} Q26 ${y - 6} 50 ${y} T92 ${y}`} fill="none" stroke="var(--kb-rank-accent-10)" strokeWidth="2.4" opacity="0.22" />
        )}
      ...
      {locked && <g opacity="0.82"><rect x="42" y="49" width="16" height="13" rx="2.5" fill="var(--kb-rank-accent-4)" /><path d="M44 49 V44 a6 6 0 0 1 12 0 V49" fill="none" stroke="var(--kb-rank-accent-4)" strokeWidth="2.6" /></g>}
    </svg>);
    ...
    <div className="kbv-prestige-panel">
        ...
        <div className="pp-current">
          ...
          <div className="pp-current-meta">
            ...
            <span className="pp-rank">
              {master ? `${prestigeName(PRESTIGE_MAX)} · grado supremo` : prestiged ? `P${completed} · ${prestigeName(completed)} · ${CELESTIAL[completed - 1].sub}` : `${RANK_NAMES[rankTier(level)]} · Nivel ${level}`}
            </span>
            {master ?
      ...
      <div className="pp-gallery">
          ...
          return (
            ...
            title={unlocked ? `${c.n === PRESTIGE_MAX ? 'Maestro' : 'Prestigio ' + c.n} · ${prestigeName(c.n)} (${c.sub})` : `Bloqueado · prestigio ${c.n}`} style={{ backgroundColor: "rgb(247, 247, 248)", textAlign: "left", borderWidth: "1px", borderStyle: "none", borderColor: "rgb(255, 255, 255)" }}>
                <PrestigeEmblem tier={c.n} locked={!unlocked} size={46} />
                <span className="pp-emblem-name">{prestigeName(c.n)}</span>
      ...
      <div className="pp-next-reward">
          ...
          <div className="pp-nr-body">
            ...
            <span className="pp-nr-text">Prestigio {completed + 1}: {prestigeName(Math.min(completed + 1, PRESTIGE_MAX))} · {(CELESTIAL[completed] || CELESTIAL[CELESTIAL.length - 1]).sub}</span>
          </div>
        </div>
      }
      {master &&
